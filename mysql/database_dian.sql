...
CREATE TABLE `movies` (
  ...
  CONSTRAINT `movies_status` FOREIGN KEY (`status`) REFERENCES `movie_status` (`id`)
...
CREATE TABLE `schedules` (
  ...
  PRIMARY KEY (`id`),
  KEY `movies_schedule_idx` (`movie_id`),
  KEY `location_schedule_idx` (`location_id`),
  KEY `time_schedule_idx` (`time_id`),
  CONSTRAINT `location_schedule` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`),
  CONSTRAINT `movies_schedule` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`),
  CONSTRAINT `time_schedule` FOREIGN KEY (`time_id`) REFERENCES `show_times` (`id`)
...
INSERT INTO `schedules` VALUES (1,1,1,3),(2,1,1,4),(3,1,1,5),(4,1,2,1),(5,1,2,5),(6,1,2,6),(7,1,3,1),(8,1,3,2),(9,1,3,3),(10,2,2,2),(11,2,2,4),(12,2,2,6),(13,3,1,3),(14,3,3,5),(15,3,3,6),(16,4,1,1),(17,4,2,2),(18,4,2,4),(19,4,3,3),(20,5,1,5),(21,5,2,5),(22,5,3,5),(23,6,1,1),(24,6,2,2),(25,6,3,3),(26,8,1,4),(27,8,1,6),(28,9,1,1),(29,9,1,2),(31,9,1,3),(32,10,2,6);
...
CREATE TABLE `users` (
  ...
  `status` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `users_roles_idx` (`role`),
  KEY `users_status_idx` (`status`),
  CONSTRAINT `users_roles` FOREIGN KEY (`role`) REFERENCES `roles` (`id`),
  CONSTRAINT `users_status` FOREIGN KEY (`status`) REFERENCES `status` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'1612334602129','kungfu','kungfu@gmail.com','34dd334dc26433e5f7917c8d4bc1d23e',2,3),(2,'1612334718687','banana','banana@gmail.com','dfc884f29610ce7b4ca6a3e42863de5c',2,1),(3,'1612335848427','icebear','icebear@gmail.com','93e6a390abd4e07bae6a615a0ec92d36',1,1);
...
-- Dump completed on 2021-02-03 16:50:14
